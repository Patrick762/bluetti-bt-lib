...
from ..fields import FieldName, UIntField, DecimalField, SwitchField, IntField
    ...
    def __init__(self):
        super().__init__(
            [
                ...
                UIntField(FieldName.HOUSE_LOAD_POWER, 142,1),
                ...
                UIntField(FieldName.CTRL_GRID_MAX_IMPORT_POWER, 2213),
                UIntField(FieldName.CTRL_GRID_MAX_EXPORT_POWER, 2215),
           ],
        )
