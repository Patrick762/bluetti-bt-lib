...
from ..enums import ChargingMode, EcoMode, LedPanelState
from ..fields import (
    BoolField,
    DecimalField,
    EnumField,
    ...
    def __init__(self):
        super().__init__(
            [
                ...
                WriteableUIntField(
                    FieldName.CTRL_ECO_MIN_POWER_DC, 2016, min=5, max=10
                ),
                BoolField(FieldName.CTRL_ECO_AC, 2017),
                SelectField(FieldName.CTRL_ECO_TIME_MODE_AC, 2018, EcoMode),
                WriteableUIntField(
                    FieldName.CTRL_ECO_MIN_POWER_AC, 2019, min=15, max=30
                ),
                EnumField(FieldName.CTRL_CHARGING_MODE, 2020, ChargingMode),
