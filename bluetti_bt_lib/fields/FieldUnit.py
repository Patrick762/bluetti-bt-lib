...
FIELD_UNIT: Dict[FieldName, str] = {
    ...
    FieldName.CTRL_GRID_MAX_IMPORT_POWER: "W",
    FieldName.CTRL_GRID_MAX_EXPORT_POWER: "W",
    ...
    FieldName.TOTAL_GRID_CONSUMPTION: "kWh",
    FieldName.TOTAL_GRID_FEED: "kWh",
    FieldName.TOTAL_LOAD_CONSUMPTION: "kWh",
    # Battery pack fields
