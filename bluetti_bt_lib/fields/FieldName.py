...
class FieldName(Enum):
    ...
    CTRL_GRID_MAX_IMPORT_POWER = "ctrl_grid_max_import_power"
    CTRL_GRID_MAX_EXPORT_POWER = "ctrl_grid_max_export_power"
    ...
    TOTAL_LOAD_CONSUMPTION = "total_load_consumption"
    VER_ARM = "version_arm"
    VER_BMS = "version_bms"
    VER_DSP = "version_dsp"
    WIFI_NAME = "wifi_name"
